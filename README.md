...
Copilot, Cursor, ChatGPT and others. Claude Code's terminal is *not* on that
list — so every tool also returns a drawn text rendering of the same state, and
the game is playable there too:
